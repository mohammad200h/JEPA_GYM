...
def make_env(record_video: bool = False):
    env = gym.make("MountainCarRepSpace-v0", max_episode_steps=MAX_EPISODE_STEPS)
...
def make_eval_env():
    env = gym.make("MountainCarRepSpace-v0", render_mode="rgb_array", max_episode_steps=MAX_EPISODE_STEPS)
